# IMPLEMENTATION.md - AI.1

## Mapeamento SPEC -> execucao

Reuso puro. Zero codigo novo. `alpha-forge validate --strategy bollinger --bollinger-window 20 --bollinger-num-std 1.25 --regime-filter atr_regime:window=14:min_atr_bps=105 ...`.
