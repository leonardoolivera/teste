# IMPLEMENTATION.md - AI.3

## Mapeamento SPEC -> execucao

Reuso puro. Zero codigo novo. `alpha-forge validate --strategy bollinger --bollinger-window 20 --bollinger-num-std 1.5 --regime-filter atr_regime:window=14:min_atr_bps=90 ...`.
