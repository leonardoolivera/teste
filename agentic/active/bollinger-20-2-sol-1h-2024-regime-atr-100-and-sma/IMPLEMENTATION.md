# IMPLEMENTATION.md - X.3 bollinger SOL 1h 2024

> Gate: **implementação**. Zero código novo.

## CLI

`alpha-forge validate --strategy bollinger --bollinger-window 20 --bollinger-num-std 2.0 --dataset-id solusdt_1h_20240705_20241231_binance_spot --regime-filter and(atr_regime:window=14:min_atr_bps=100,sma_slope:window=50:min_slope_bps=10) --stress fee+10:10:0:0 --stress spread+10:0:0:10 --run-id bollinger-20-2-sol-1h-2024-regime-atr-100-and-sma --mc-seed 42 --mc-resamples 1000`
