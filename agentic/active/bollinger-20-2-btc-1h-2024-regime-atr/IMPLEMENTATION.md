# IMPLEMENTATION.md — P.2 Bollinger BTC 1h 2024 + atr_regime
...
--stress spread+10:0:0:10 --run-id bollinger-20-2-btc-1h-2024-regime-atr
...
| §4 | `BollingerMeanReversionStrategy(window=20, num_std=2.0, long_only=True)` + `ATRRegimeFilter(window=14, min_atr_bps=50)` |
