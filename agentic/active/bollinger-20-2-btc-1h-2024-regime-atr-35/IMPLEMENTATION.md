# IMPLEMENTATION.md - T.1 Bollinger BTC 1h 2024 + atr_regime:35

> Gate: **implementação**. Zero código novo.

## CLI

`alpha-forge validate --strategy bollinger --bollinger-window 20 --bollinger-num-std 2.0 --dataset-id btcusdt_1h_20240705_20241231_binance_spot --regime-filter atr_regime:window=14:min_atr_bps=35 --stress fee+10:10:0:0 --stress spread+10:0:0:10 --run-id bollinger-20-2-btc-1h-2024-regime-atr-35 --mc-seed 42 --mc-resamples 1000`
...
| strategy | `BollingerMeanReversionStrategy(20, 2.0, long_only=True)` + `ATRRegimeFilter(14, 35)` |
| custos | H.1 |
