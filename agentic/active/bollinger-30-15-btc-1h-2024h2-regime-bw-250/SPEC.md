# SPEC.md - AZ.2 bollinger 30/1.5 BTC 1h 2024-H2 + bollinger_width:250

> Gate: **pesquisa**. Serie AZ.

## Hipotese

BTC 30/1.5 long_only + bollinger_width:250 em 2024-H2. Serie AZ formaliza achado da exploracao AL-AY: strategy window=30 Pareto-domina w=20 em MDD e min p5 cross-year. bollinger_width:250 w=20 ns=2.0 e o filtro de regime com menor MDD cross-window. Piloto passa ALL strict gates (p5>=10000, mdd p95<=10%, ratio>=0.95, fee==spread).
