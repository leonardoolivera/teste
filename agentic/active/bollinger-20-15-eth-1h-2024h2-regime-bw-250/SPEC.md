# SPEC.md - AK.6 bollinger ETH 1h 2024-H2 + bollinger_width

> Gate: **pesquisa**. Serie AK.

## Hipotese

ETH 20/1.5 + bollinger_width:250 em 2024-H2 - nova familia de filtro (volatilidade estrutural via largura de banda) ortogonal ao ATR (candle range).
