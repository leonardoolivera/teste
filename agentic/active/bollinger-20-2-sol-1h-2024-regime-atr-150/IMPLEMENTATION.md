# IMPLEMENTATION.md — R.2 Bollinger SOL 1h 2024 + atr_regime:150
...
--regime-filter atr_regime:window=14:min_atr_bps=150 --stress fee+10:10:0:0
--stress spread+10:0:0:10 --run-id bollinger-20-2-sol-1h-2024-regime-atr-150
...
| §4 | `BollingerMeanReversionStrategy(20, 2.0, long_only=True)` + `ATRRegimeFilter(14, 150)` |
