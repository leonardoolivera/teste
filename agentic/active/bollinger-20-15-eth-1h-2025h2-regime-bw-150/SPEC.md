# SPEC.md - AK.4 bollinger ETH 1h 2025-H2 + bollinger_width

> Gate: **pesquisa**. Serie AK.

## Hipotese

ETH 20/1.5 + bollinger_width:150 em 2025-H2 - nova familia de filtro (volatilidade estrutural via largura de banda) ortogonal ao ATR (candle range).
