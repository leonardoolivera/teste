"""Resumir Serie CV (RSI long cross-period 2024-H2 + 2025-H2)."""
...
OUT = ROOT / "exports" / "diag" / "series_cv_summary.json"

PILOTS = [
    ("CV.1", "cv-btc-rsi-long-2024h2", "BTC", "2024-H2"),
    ("CV.2", "cv-eth-rsi-long-2024h2", "ETH", "2024-H2"),
    ("CV.3", "cv-sol-rsi-long-2024h2", "SOL", "2024-H2"),
    ("CV.4", "cv-btc-rsi-long-2025h2", "BTC", "2025-H2"),
    ("CV.5", "cv-eth-rsi-long-2025h2", "ETH", "2025-H2"),
    ("CV.6", "cv-sol-rsi-long-2025h2", "SOL", "2025-H2"),
]
...
def main():
    ...
    print(f"{'Tag':<6} {'Asset':<5} {'Window':<8} {'Tr':>4} {'PnL%':>8} {'MDD%':>6} {'Sh':>7} {'MCp5':>6} {'costr':>6}  Verdict")
    for r in rows:
    ...
    for w, rs in by_window.items():
        ...
        print(f"  {w}: {p}/3 PASS, avg Sh = {avg_sh:.3f}")
