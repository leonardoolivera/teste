"""Resumir Serie CZ8 (MACX 20/50 + bollinger_width, ADR-0128)."""
...
OUT = ROOT / "exports" / "diag" / "series_cz8_summary.json"

PROBES = [
    ("CZ8.1", "cz8-btc-macx-2050-bw300-1h-2024h2", "BTC 1h 2024-H2 bull"),
    ("CZ8.2", "cz8-eth-macx-2050-bw300-1h-2024h2", "ETH 1h 2024-H2 bull"),
    ("CZ8.3", "cz8-sol-macx-2050-bw300-1h-2024h2", "SOL 1h 2024-H2 bull"),
    ("CZ8.4", "cz8-btc-macx-2050-bw300-1h-2025h2", "BTC 1h 2025-H2 misto"),
    ("CZ8.5", "cz8-eth-macx-2050-bw300-1h-2025h2", "ETH 1h 2025-H2 misto"),
    ("CZ8.6", "cz8-sol-macx-2050-bw300-1h-2025h2", "SOL 1h 2025-H2 misto"),
]

NAKED = {
    "CZ8.1": (36, 2.39), "CZ8.2": (34, 1.88), "CZ8.3": (32, 1.22),
    "CZ8.4": (29, -2.17), "CZ8.5": (34, -1.47), "CZ8.6": (36, -2.44),
}
