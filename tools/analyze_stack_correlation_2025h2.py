"""Meta-analise: correlacao retornos dos combos live do stack em 2025-H2.

Analise analoga ao analyze_stack_correlation_2025h1.py (ADR-0156).
7 combos 2025-H2 ativos; matriz Pearson dos retornos hora-a-hora.

Output: exports/diag/stack_correlation_2025h2.json
"""
...
OUT = ROOT / "exports" / "diag" / "stack_correlation_2025h2.json"

COMBOS = [
    ("bol_short_BTC", "cg-bol-20-15-btc-20250705_20251231-width30-300-short"),
    ("bol_short_ETH", "cg-bol-20-15-eth-20250705_20251231-width30-300-short"),
    ("bol_short_SOL", "cg-bol-20-15-sol-20250705_20251231-width30-300-short"),
    ("rsi_short_width_BTC", "ch-rsi-14-30-70-btc-20250705_20251231-width30-300-short"),
    ("rsi_short_width_ETH", "ch-rsi-14-30-70-eth-20250705_20251231-width30-300-short"),
    ("rsi_short_width_SOL", "ch-rsi-14-30-70-sol-20250705_20251231-width30-300-short"),
    ("rsi_short_trendhtf_SOL_2575", "cz11-sol-rsi-2575-trendhtf-1h-2025h2"),
]
