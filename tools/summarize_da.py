"""Resumir Serie DA (bol_short + trend_htf, ADR-0158)."""
...
OUT = ROOT / "exports" / "diag" / "series_da_summary.json"

PROBES = [
    ("DA.1", "da-btc-bol-w20-ns1.5-trendhtf-short-1h-2025h1", "BTC bol+trendhtf", 2.33),
    ("DA.2", "da-eth-bol-w20-ns1.5-trendhtf-short-1h-2025h1", "ETH bol+trendhtf", 2.40),
    ("DA.3", "da-sol-bol-w20-ns1.5-trendhtf-short-1h-2025h1", "SOL bol+trendhtf", 2.71),
]
