"""Resumir KE Fase 3 (Keltner 4h), ADR-0173."""
...
OUT = ROOT / "exports" / "diag" / "series_ke_4h_summary.json"

PROBES = [
    ("KE.13", "ke-btc-keltner-20-14-20-short-4h-2025h1", "BTC Keltner 4h"),
    ("KE.14", "ke-eth-keltner-20-14-20-short-4h-2025h1", "ETH Keltner 4h"),
    ("KE.15", "ke-sol-keltner-20-14-20-short-4h-2025h1", "SOL Keltner 4h"),
]


def annual_sharpe_4h(rets):
    """4h timeframe: sqrt(6*365) annual factor."""
    n = len(rets)
    if n < 2: return 0.0
    mean = sum(rets) / n
