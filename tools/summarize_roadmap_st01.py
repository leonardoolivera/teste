"""Resumir Batch ST01 — supertrend bear-avoidance validation 10m ETH/SOL 2025-H1."""
...
OUT = ROOT / "exports" / "diag" / "roadmap_st01_summary.json"


ENTRIES = [
    ("ST01.01", "t1st-10-2-eth-2025h1-bi-10m", "ETH 2025-H1", "atr=10 m=2.0 bi"),
    ("ST01.02", "t1st-10-2-sol-2025h1-bi-10m", "SOL 2025-H1", "atr=10 m=2.0 bi"),
    ("ST01.03", "t1st-10-4-eth-2025h1-bi-10m", "ETH 2025-H1", "atr=10 m=4.0 bi"),
    ("ST01.04", "t1st-10-4-sol-2025h1-bi-10m", "SOL 2025-H1", "atr=10 m=4.0 bi"),
    ("ST01.05", "t1st-14-3-eth-2025h1-bi-10m", "ETH 2025-H1", "atr=14 m=3.0 bi"),
    ("ST01.06", "t1st-14-3-sol-2025h1-bi-10m", "SOL 2025-H1", "atr=14 m=3.0 bi"),
    ("ST01.07", "t1st-10-3-eth-2025h1-long-10m", "ETH 2025-H1", "atr=10 m=3.0 long"),
    ("ST01.08", "t1st-10-3-sol-2025h1-long-10m", "SOL 2025-H1", "atr=10 m=3.0 long"),
    ("ST01.09", "t1st-20-3-eth-2025h1-bi-10m", "ETH 2025-H1", "atr=20 m=3.0 bi"),
    ("ST01.10", "t1st-20-3-sol-2025h1-bi-10m", "SOL 2025-H1", "atr=20 m=3.0 bi"),
]
...
def main():
    out_all = []
    print(f"\n{'=' * 90}\nBatch ST01 — supertrend 10m bear-val (ETH/SOL 2025-H1)\n{'=' * 90}")
    print(f"{'Tag':<9} {'Params':<18} {'Label':<14} {'Tr':>5} {'Sh':>7} {'PnL%':>8}  {'B&H%':>6}  {'alfa':>7}  Gates")
    for tag, rid, label, params in ENTRIES:
        try:
            m = metrics(rid)
        except FileNotFoundError:
            print(f"{tag:<9} {params:<18} {label:<14}  MISSING ({rid})")
            continue
        ...
        print(
            f"{tag:<9} {params:<18} {label:<14} {m['trades']:>5} "
