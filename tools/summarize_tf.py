"""Resumir Serie TF Fase 1 (BB+width 15m 2024-H2, ADR-0177)."""
...
OUT = ROOT / "exports" / "diag" / "series_tf_summary.json"

PROBES = [
    ("TF.1", "tf-btc-bol-width-20-2-short-15m-2024h2", "BTC BB+width 15m"),
    ("TF.2", "tf-eth-bol-width-20-2-short-15m-2024h2", "ETH BB+width 15m"),
    ("TF.3", "tf-sol-bol-width-20-2-short-15m-2024h2", "SOL BB+width 15m"),
]


def annual_sharpe_15m(rets):
    """15m: sqrt(96*365) annual factor."""
    n = len(rets)
    if n < 2: return 0.0
    mean = sum(rets) / n
