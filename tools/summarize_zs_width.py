"""Resumir ZS Fase 3 +width filter (ADR-0175 salvage)."""
...
OUT = ROOT / "exports" / "diag" / "series_zs_width_summary.json"

PROBES = [
    ("ZS.10", "zs-btc-zscore-20-2-short-width-1h-2025h1", "BTC zscore+width"),
    ("ZS.11", "zs-eth-zscore-20-2-short-width-1h-2025h1", "ETH zscore+width"),
    ("ZS.12", "zs-sol-zscore-20-2-short-width-1h-2025h1", "SOL zscore+width"),
]
