"""Resumir Serie CX (Donchian naked cross-period)."""
...
OUT = ROOT / "exports" / "diag" / "series_cx_summary.json"

PILOTS = [
    ("CX.1", "cx-btc-donchian-20-10-2024h2", "BTC", "2024-H2"),
    ("CX.2", "cx-eth-donchian-20-10-2024h2", "ETH", "2024-H2"),
    ("CX.3", "cx-sol-donchian-20-10-2024h2", "SOL", "2024-H2"),
    ("CX.4", "cx-btc-donchian-20-10-2025h1", "BTC", "2025-H1"),
    ("CX.5", "cx-eth-donchian-20-10-2025h1", "ETH", "2025-H1"),
    ("CX.6", "cx-sol-donchian-20-10-2025h1", "SOL", "2025-H1"),
    ("CX.7", "cx-btc-donchian-20-10-2025h2", "BTC", "2025-H2"),
    ("CX.8", "cx-eth-donchian-20-10-2025h2", "ETH", "2025-H2"),
    ("CX.9", "cx-sol-donchian-20-10-2025h2", "SOL", "2025-H2"),
]
...
def main():
    ...
    print(f"{'Tag':<6} {'Asset':<5} {'Win':<8} {'Tr':>4} {'PnL%':>8} {'MDD%':>6} {'Sh':>7} {'MCp5':>6} {'costr':>6}  Verdict")
    for r in rows:
        mc = r['mc_p5'] if r['mc_p5'] is not None else 0
        cr = r['cost_r'] if r['cost_r'] is not None else 0
        print(f"{r['tag']:<6} {r['asset']:<5} {r['window']:<8} {r['trades']:>4} {r['pnl_pct']:>8.2f} "
