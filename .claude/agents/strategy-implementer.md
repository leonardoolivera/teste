...
1. `AGENTS.md` + `CLAUDE.md` + `STATE.md` + `agentic/README.md`.
2. `agentic/active/<slug>/SPEC.md` — a hipótese que você vai implementar.
3. `system/domain.md`, `system/api.md`, `system/flows.md` — o que já existe.
4. Padrões de código obrigatórios: `decisions/0002-anti-lookahead-as-infrastructure.md`, `0004-minimal-risk-policy.md`, `0006-minimal-execution-cost-model.md` + `0019-synthetic-spread-cost-component.md` (três componentes de custo), `0008-first-real-strategy-ma-crossover.md`, `0011-donchian-breakout-strategy.md`, `0012-ma-crossover-short-side.md`, `0013-donchian-short-side.md`.
...
2. `agentic/active/<slug>/IMPLEMENTATION.md` atualizado.
