...
2. Todos os artefatos do piloto em `agentic/active/<slug>/`: `SPEC.md`, `IMPLEMENTATION.md`, `VALIDATION.md`, `BACKTEST.md`, `CHECKLIST.md`.
3. `STATE.md` + ADRs relevantes (pipeline completo: 0014 cost_stress, 0015 persistence, 0016 CLI validate, 0017 run metadata, 0018 CLI compare, 0019 spread).
...
6. Corridas persistidas do piloto em `results/validation/<slug>/` (walk_forward.json, monte_carlo.json, cost_stress.json, run.json).
...
1. `agentic/active/<slug>/AUDIT.md` escrito.
