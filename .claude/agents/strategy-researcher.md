...
5. `decisions/` — ADRs relevantes: 0002 causalidade, 0004 risco, 0006 custos (fee+slip), 0008 MA long-only, 0011 Donchian long-only, 0012 MA short-side opt-in, 0013 Donchian short-side opt-in, 0014 cost_stress, 0019 spread sintético (terceiro componente de custo).
6. `STATE.md` — contexto atual.
7. `agentic/README.md` — layout de templates + active; onde grava SPEC.md.
...
1. `agentic/active/<slug>/SPEC.md` completo escrito no lugar.
